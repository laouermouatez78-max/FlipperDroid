...
fun AboutScreen() {
    LazyColumn(
        ...
        item { HeroBanner("FlipperDroid 6.0", "Refonte complète orientée diagnostic, pentest autorisé et laboratoire mobile.") }
        item { ValueCard("Version", "6.0.0 · code 6") }
        item { ValueCard("Android", "API 24+ · cible API 36 · Jetpack Compose / Material 3") }
        item { ValueCard("Nouveautés V6", "Résolution fabricant BLE, détection d'adresse aléatoire, export CSV BLE/Wi‑Fi, type de puce NFC, test IR borné, sondage multi-ports, détection de dongle Sub-GHz externe.") }
