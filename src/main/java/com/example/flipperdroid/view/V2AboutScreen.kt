            ...
            item {
                Card(modifier = Modifier.fillMaxWidth().padding(horizontal = 16.dp)) {
                    Column(Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
                        Text("V2 changes", style = MaterialTheme.typography.titleMedium, fontWeight = FontWeight.Bold)
                        Text("• New V2 home and clearer navigation")
                        Text("• Safe-by-default module exposure")
                        Text("• NFC reading, history and real export")
                        Text("• Defensive network diagnostics UI")
                        Text("• Device capability status screen")
                        Text("• Reduced Android permissions")
                    }
                }
            }
                ...
                Card(modifier = Modifier.fillMaxWidth().padding(horizontal = 16.dp, vertical = 4.dp)) {
                    Row(
                        ...
                        Column {
                            ...
                            Text("Based on the open-source FlipperDroid project by Jeremiznoo. This V2 fork keeps the upstream attribution and license terms.")
                        }
                    }
                }
            }
