...
fun HomeScreen(
    ...
    val tools = listOf(
        FeatureItem("NFC Reader", "Inspect compatible NFC tags and export your own scan data.", Icons.Default.Nfc, "nfc"),
        FeatureItem("Network Diagnostics", "Ping, route and diagnostic utilities for authorized networks.", Icons.Default.Router, "network"),
        FeatureItem("Infrared", "Use supported IR hardware as a remote for your own devices.", Icons.Default.SettingsRemote, "ir"),
        FeatureItem("Password Generator", "Generate strong random passwords locally on-device.", Icons.Default.Key, "password_generator")
    )

    val appItems = listOf(
        FeatureItem("Settings", "Theme and application preferences.", Icons.Default.Settings, "settings"),
        FeatureItem("About V2", "Version, credits, safety model and project information.", Icons.Default.Info, "about")
    )
